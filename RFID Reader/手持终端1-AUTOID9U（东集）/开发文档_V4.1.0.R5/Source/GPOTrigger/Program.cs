...
using System.Text;
using JW.UHF;
namespace GPOTrigger
{
    class Program
    {
        static JWReader jwReader = new JWReader("COM3");
          /// <summary>
        /// 数据上报
        /// </summary>
        ...
        private static void TagsReport(object sender, TagsEventArgs args)
        {
            ...
            GPIOConfig config = new GPIOConfig();
            config.GPO0_VALUE = GPOTriggerValue.Hign;
            config.GPO1_VALUE = GPOTriggerValue.Hign;
            jwReader.RFID_Set_GPO(config);
        }
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Press Enter Key End");
            Console.ReadLine();
